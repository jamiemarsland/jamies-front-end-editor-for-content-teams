...
add_action( 'wp_footer', function () {
	...
	<div data-wp-interactive="jamies-front-end-editor-for-content-teams" class="fie-toolbar-wrap">
		<div class="fie-lock-banner" hidden data-wp-bind--hidden="!state.lockedByName">
		...
		<div class="fie-modal-overlay" hidden data-wp-bind--hidden="!state.buttonOpen" data-wp-on--click="actions.buttonBackdrop">
